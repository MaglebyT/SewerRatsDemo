...
public class NPCController : MonoBehaviour, Interactable, ISavable
{
    ...
    private void Awake()
    {
        ...
        fighterGiver = GetComponent<FighterGiver>();
    ...
    public IEnumerator Interact(Transform initiator)
    {
        if (state == NPCState.Idle)
        {
            ...
            else if (fighterGiver != null && fighterGiver.CanBeGiven())
            {
                yield return fighterGiver.GiveFighter(initiator.GetComponent<PlayerController>());
            }
